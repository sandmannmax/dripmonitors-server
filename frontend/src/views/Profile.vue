          ...
          <div class="card card-signin my-5">
            <div class="card-body">
              ...
              <form class="form-signin" v-if="!user.loggedIn">
                ...
                <button class="btn btn-lg btn-primary btn-block text-uppercase" type="button" v-on:click="loginForm()">Einloggen</button>
              </form>   
              <div v-else>
                <p class="signedIn-text">Bereits eingeloggt. Wollen Sie sich abmelden?</p>
                <button class="btn btn-lg btn-primary btn-block text-uppercase" type="button" v-on:click="logoutForm()">Ausloggen</button>
              </div>                         
